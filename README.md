...
* Docker
        ...
        docker run -it -v /monero/chain:/root/.bmnc -v /monero/wallet:/wallet -p 18080:18080 monero

        # or in background
        docker run -it -d -v /monero/chain:/root/.bmnc -v /monero/wallet:/wallet -p 18080:18080 monero
...
service](utils/systemd/bmncd.service) assumes that the user `monero` exists
